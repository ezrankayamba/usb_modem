...
class SMS_PDU_Test(unittest.TestCase):
    ...
    def test_sms_decode_longmsg(self):
        ...
        s = smspdu.SMS_SUBMIT.fromPDU(
            ...
            '447924449999', 'test')
        ae(s.user_data, "Just landed in London! Awaiting heathrow customs... Will find Astor Vic then off for a walk-explore (churches~gov't walk near thames) Might go to Tate. ")
...
class EncodingTest(unittest.TestCase):
    ...
    def test_chars_in_gsm(self):
        self._test('héllo ñon', ('héllo ñon', ''))
    ...
    def test_utf16(self):
        s = 'أنوس مررره وحشنييي ... بسومه حبي الشريحه تبعك اشتغلت بس مو عآرفه ط'
        self._test(s, (s, ''))
